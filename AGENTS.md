...
- `jsapi/`: native MiniApp JSAPI bridge. Main implementation is `jsapi/src/jsapi_browser/JSBrowser.cpp`.
- `wpe-drm/`: WPE DRM launcher and platform-side rendering/input code.
